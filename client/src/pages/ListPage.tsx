...
import { type Ad, type AdsListResponse, type Category, type FiltersState, type PaginationMeta } from '../types';
...
const ListPage = () => {
  ...
  const fetchAds = async () => {
    ...
    try {
      ...
      const data = await api.get<AdsListResponse>(endpoints.ads.list, params);
      setAds(data.ads);
